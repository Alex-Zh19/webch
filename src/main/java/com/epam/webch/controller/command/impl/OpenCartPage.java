...
public class OpenCartPage implements Command {
    ...
    public Router execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        if(currentRole== User.UserRole.guest){
            request.getSession().setAttribute(SessionAttribute.PREVIOUS_PAGE.name(), PagePath.GUEST_CART_PAGE.getValue());
            ...
            request.getSession().setAttribute(SessionAttribute.PREVIOUS_PAGE.name(), PagePath.USER_CART_PAGE.getValue());
