...
public class OpenSignUpPage implements Command {
    ...
    public Router execute(HttpServletRequest request) {
        request.getSession().setAttribute(SessionAttribute.PREVIOUS_PAGE.name(), PagePath.SIGN_UP_PAGE);
        return new Router(PagePath.SIGN_UP_PAGE.getValue(), Router.RouterType.FORWARD);
    }
}
